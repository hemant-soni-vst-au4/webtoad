(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["polyfills-css-shim"], {
    ...
    "sVK1":
    /*!********************************************************************************************!*\
      !*** ./node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/css-shim-2ccf4dec.js ***!
      \********************************************************************************************/

    /*! no static exports found */

    /***/
    function sVK1(module, exports) {
      /*
       Stencil Client Patch Esm v2.5.0 | MIT Licensed | https://stenciljs.com
       */
      var _assign2 = function __assign() {
        return (_assign2 = Object.assign || function (e) {
          for (var t, r = 1, n = arguments.length; r < n; r++) {
            for (var s in t = arguments[r]) {
              Object.prototype.hasOwnProperty.call(t, s) && (e[s] = t[s]);
            }
      ...
      function reScope(e, t) {
        var r = e.template.map(function (r) {
          return "string" == typeof r ? replaceScope(r, e.scopeId, t) : r;
            ...
            n = e.selectors.map(function (r) {
          return _assign2(_assign2({}, r), {
            selector: replaceScope(r.selector, e.scopeId, t)
          });
        });
        return _assign2(_assign2({}, e), {
          template: r,
          selectors: n,
          scopeId: t
        });
