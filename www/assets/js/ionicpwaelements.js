...
*/
    ...
    !(function (undefined) {
      ...
      !(function (t) {
        ...
        function (t, r, n) {
          ...
          t.exports = function (t, r, n) {
            var s = r + ' Iterator'
            return (t.prototype = o(e, {next: i(1, n)})), u(t, s, !1, !0), (a[s] = c), t
          }
        },
        function (t, r, n) {
          'use strict'
            ...
            a = function (t) {
              return function (r, n, a) {
                ...
                return p <= l || '' == h
                  ? f
                  : ((c = p - l),
                    (s = o.call(h, u(c / h.length))).length > c && (s = s.slice(0, c)),
                    t ? f + s : s + f)
              }
            }
        ...
        function (t, r, n) {
          ...
          var e = n(0),
            ...
            E = function (t) {
              return (
                w[t - 1] || (w[t - 1] = RegExp('((?:%[\\da-f]{2}){' + t + '})', 'gi'))
              )
            },
            O = function (t) {
              try {
            ...
            N = c(
              ...
              function () {
                ...
                return (
                  n.done ||
                    (n.value =
                      'keys' === r ? e.key : 'values' === r ? e.value : [e.key, e.value]),
                  n
                )
              },
            ),
            T = function () {
              ...
              if (
                ...
                if (v(a))
                  ...
                  else for (u in a) l(a, u) && s.push({key: u, value: a[u] + ''})
                else
                  L(
                    s,
                    'string' == typeof a
            ...
            {target: 'String', proto: !0},
            {
              matchAll: function (t) {
                var r,
                  ...
                  o = i(this)
                return null != t &&
                  (void 0 === (n = t[y]) && d && 'RegExp' == s(t) && (n = E), null != n)
                  ? a(n).call(t, o)
                  : ((r = String(o)),
                    (e = new RegExp(t, 'g')),
                    d ? E.call(e, r) : e[y](r))
        ...
        function (t, r, n) {
          ...
          e(
            {target: 'String', stat: !0},
            {
              raw: function (t) {
                for (
                  var r = o(t.raw), n = i(r.length), e = arguments.length, u = [], a = 0;
                  n > a;
                    ...
                    ? function (t, n) {
                        ...
                        for (
                          ...
                          !(
                            ...
                            a.length > 1 && a.index < e.length && p.apply(f, a.slice(1)),
                            (s = a[0].length),
                            (v = c),
                            f.length >= i)
                          );
            ...
            i(d, {
              ...
              has: function (t) {
                if (s(t) && !p(t)) {
                  var r = f(this)
                  return (
                    r.frozen || (r.frozen = new e()), x.call(this, t) || r.frozen.has(t)
                  )
                }
              ...
              return (
                null !== o
                  ? ((s += '//'),
                    ...
                    null !== i && (s += ':' + i))
                  : 'file' == r && (s += '//'),
                (s += t.cannotBeABaseURL ? u[0] : u.length ? '/' + u.join('/') : ''),
                null !== a && (s += '?' + a),
                null !== c && (s += '#' + c),
                s
              )
    ...
    !(function (t, e) {
      ...
      function c() {
        return (
          ...
          (this.text = function () {
            ...
            if (this._bodyBlob)
              return (
                (t = this._bodyBlob), (r = f((e = new FileReader()))), e.readAsText(t), r
              )
            if (this._bodyArrayBuffer)
      ...
      ;(w.polyfill = !0),
        self.fetch ||
          ((self.fetch = w), (self.Headers = a), (self.Request = y), (self.Response = b)),
        (t.Headers = a),
        (t.Request = y),
        (t.Response = b),
        (t.fetch = w),
...
*/
    ...
    function compileVar(cssText, template, offset) {
      ...
      var fallback =
        varMeta.fallback != null ? compileTemplate(varMeta.fallback) : undefined
    ...
    var scriptElm =
      ...
      Array.from(doc.querySelectorAll('script')).find(function (s) {
        return (
          regex.test(s.src) ||
          s.getAttribute('data-stencil-namespace') === 'ionicpwaelements'
        )
      })
