  ...
  function (e, t, n) {
    ...
    var ye,
      ...
      Oe = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Object.defineProperty(n, 'message', {value: n.message, enumerable: !0}),
            n
          )
        }
        return a(t, e), t
      ...
      ft = function (e) {
        return function (t, n) {
          if (Array.isArray(t)) {
            return t
              .map(function (t, r) {
                return e(t, ze({}, n, {path: [].concat(c(n.path), [String(r)])}))
              })
              .reduce(function (e, t) {
                return 'error' === e.type
                  ? e
      ...
      gt = function (e, t, n, r) {
        ...
        return 'valid' === a.type
          ...
          : {
              type: 'error',
              errorType: 'full',
              error: new ke(Ye(a.expected, a.actual, a.options)),
            }
      },
      Et = function (e, t, n, r) {
        var o = gt(e, t, n, r)
      ...
      Tt = Object({
        ...
        ELEMENTS_INNER_CARD_HTML_NAME:
          'elements-inner-card-95ff80dcb9b0b180bdada71ad8c849b3.html',
        ELEMENTS_INNER_IBAN_HTML_NAME:
          'elements-inner-iban-bf4eabede1098950ecebc4704a1d0a0a.html',
        ELEMENTS_INNER_IDEAL_BANK_HTML_NAME:
          'elements-inner-ideal-bank-030bfa35f364eefe15879ba1ae8ebcbc.html',
        ELEMENTS_INNER_PAYMENT_REQUEST_HTML_NAME:
          'elements-inner-payment-request-0d61a46ad3a0b5ee96efd66bdc81fbf8.html',
        ELEMENTS_INNER_AU_BANK_ACCOUNT_HTML_NAME:
          'elements-inner-au-bank-account-c9d8f6ad8fcc6147ba8942aeb3f5b5ab.html',
        ELEMENTS_INNER_FPX_BANK_HTML_NAME:
          'elements-inner-fpx-bank-7f73addb32b406a3fcd49d8b90e29c1b.html',
        RECAPTCHA_HTML_NAME: 'recaptcha.html',
        CONTROLLER_HTML_NAME: 'controller-a3739bef1f7e07ab1d399458aac9e1df.html',
        PAYMENT_REQUEST_INNER_BROWSER_HTML_NAME:
          'payment-request-inner-browser-12c02a75e1c52c9cd5e1c85004d61a65.html',
        PAYMENT_REQUEST_INNER_GOOGLE_PAY_HTML_NAME:
          'payment-request-inner-google-pay-66c8275d32d4ed16ce19181754fd22d9.html',
        AUTHORIZE_WITH_URL_INNER_HTML_NAME:
          'authorize-with-url-inner-e62ee79c7dfae3421c8be5692adca132.html',
        THREE_DS_2_CHALLENGE_HTML_NAME:
          'three-ds-2-challenge-b0a3ae218256bf335cc7ba2edfbf5a89.html',
        THREE_DS_2_FINGERPRINT_HTML_NAME:
          'three-ds-2-fingerprint-0cd0bd50937f976a821eb55ca19cbcda.html',
      ...
      Yt = function e() {
        ...
        return t
          ? (parseInt(t, 10) ^ ((16 * Math.random()) >> (parseInt(t, 10) / 4))).toString(
              16,
            )
      ...
      tn = function (e) {
        if (!document.body)
          throw new ke('Stripe.js requires that your page has a <body> element.')
      ...
      rn = function (e) {
        ...
        'controller' === r
          ...
          a && a.postMessage(JSON.stringify(nn({}, e, {__stripeJsV3: !0})), o)
      },
      on = function (e) {
        try {
            ...
            },
            {
              ...
              value: function (e) {
                this._ensureMounted(),
                  this.loaded
                    ? rn(e)
                    : (this._queuedMessages = [].concat(l(this._queuedMessages), [e]))
              },
            },
            {
              key: 'appendTo',
      ...
      En = (function (e) {
        function t(e, n, r) {
          ...
          if (((o.autoload = r.autoload || !1), 'complete' === document.readyState))
            o._ensureMounted()
          else {
      ...
      Gn = {position: 'absolute', left: '0', top: '0', height: '100%', width: '100%'},
      Yn = (function (e) {
        function t(e, n, r) {
          P(this, t)
      ...
      br =
        ...
        R(ye, Mt.cardNumber, {unique: !0, conflict: [Mt.card], beta: !1}),
        R(ye, Mt.cardExpiry, {unique: !0, conflict: [Mt.card], beta: !1}),
        R(ye, Mt.cardCvc, {unique: !0, conflict: [Mt.card], beta: !1}),
        R(ye, Mt.postalCode, {unique: !0, conflict: [Mt.card], beta: !1}),
        R(ye, Mt.paymentRequestButton, {unique: !0, conflict: [], beta: !1}),
        R(ye, Mt.iban, {unique: !0, conflict: [], beta: !1}),
        R(ye, Mt.idealBank, {unique: !0, conflict: [], beta: !1}),
        R(ye, Mt.auBankAccount, {unique: !0, beta: !0, conflict: []}),
        R(ye, Mt.fpxBank, {unique: !0, beta: !1, conflict: []}),
        ye),
      gr = br,
      Er =
        ((ve = {}),
      ...
      kr =
        ...
        C(be, Mt.iban, Pr),
        C(be, Mt.auBankAccount, Or),
        be),
      Ar =
        ((ge = {}),
        C(ge, Mt.idealBank, {secondary: Mt.idealBankSecondary}),
        C(ge, Mt.fpxBank, {secondary: Mt.fpxBankSecondary}),
        ge),
      Tr =
        Object.assign ||
        function (e) {
      ...
      Cr = function (e) {
        return 'object' === (void 0 === e ? 'undefined' : Ir(e)) &&
          ...
          ? new ke('string' == typeof e.message ? e.message : '')
          : e
      },
      Mr = function e(t) {
        ...
        ;(this._id = Gt('__privateStripeController')),
          ...
          (this._controllerFrame = new On(At.CONTROLLER, this._id, Tr({}, t))),
          (this._frames = {}),
          (this._requests = {}),
      ...
      jr = function () {
        ...
        ;(this._sendCAReq = function (t) {
          ...
          (this.createElementFrame = function (t, n) {
            var r = n.groupId,
              o = M(n, ['groupId']),
              a = new Rn(t, e._id, Tr({}, o, {keyMode: Ue(e._apiKey), apiKey: e._apiKey}))
                    ...
                    if (hr) {
                      ...
                      'blur' === c &&
                        setTimeout(function () {
                          ...
                          if (e && !Nr(a, l) && !ar(e)) {
                            var t =
                              u && u.querySelector('.__PrivateStripeElement-safariInput')
                            if (t) {
                              var n = t
      ...
      oo = function (e, t) {
        var n = e.indexOf(':')
        if (-1 === n)
          throw new ke('Invalid css declaration in file from ' + t + ': "' + e + '"')
        var r = e.slice(0, n).trim(),
          o = Ut[r]
        if (!o)
          throw new ke('Unsupported css property in file from ' + t + ': "' + r + '"')
      ...
      ao = function (e, t) {
        ...
        return (
          ['family', 'src'].forEach(function (e) {
            if (!n[e])
              throw new ke('Missing css property in file from ' + t + ': "' + Ft[e] + '"')
          }),
          n
        )
      },
          ...
          if (Io()) {
            ...
            if (window.ApplePaySession.supportsVersion(a)) {
              ...
              return No(c).then(function (o) {
                if (
                  (r('pr.apple_pay.can_make_payment_native_response', {available: o}),
                  n && !o && window.console)
                ) {
        ...
        function e(t) {
          ...
          z(this, e),
            ...
            (this._handleValidationError = function (e) {
              return function (t) {
                n._report('error.pr.apple_pay.session_creation_failed', {error: t}),
                  e.abort()
                var r = t.message
                  ...
                  .then(function (t) {
                    if ('error' === t.type)
                      e.completePayment(window.ApplePaySession.STATUS_FAILURE),
                        n._report('error.pr.create_token_failed', {error: t.error})
                    else {
            ...
            (this._completePayment = function (e) {
              return function (t) {
                n._paymentRequestOptions = Wr(n._paymentRequestOptions, {status: t})
                var r = ta(n._paymentRequestOptions),
                  o = r.status,
                  a = r.error
                a ? e.completePayment({status: o, errors: [a]}) : e.completePayment(o),
                  (0 === o || (1 === o && null == a)) &&
                    ((n._isShowing = !1), n._onEvent && n._onEvent({type: 'close'}))
              }
            }),
      ...
      Sa = function e(t) {
        ...
        G(this, e),
          ...
          (this._handlePaymentResponse = function (e, t, r) {
            ...
            n._onEvent({type: 'paymentresponse', payload: wa({}, t, {complete: o})})
          }),
      ...
      Ia = function e(t) {
        ...
        if (
          ...
          Oa && 'https:' === window.location.protocol)
        ) {
          this._controller.action.fetchLocale({locale: 'auto'})
      ...
      Ra = function () {
        ...
        ;(this._onEvent = function () {}),
          ...
          (this.show = function () {
            if (!e._prFrame)
              throw new ke('Payment Request is not available in this browser.')
            e._prFrame.send({
              action: 'stripe-pr-show',
          ...
          (this._setupPrFrame = function (t, n) {
            t.send({action: 'stripe-pr-initialize', payload: {data: n}}),
              ...
              t._on('pr-error', function (t) {
                e._onEvent({
                  type: 'error',
                  payload: {errorMessage: t.message || '', errorCode: t.code || ''},
                })
              }),
        ...
        ;(this._usedByButtonElement = null),
          ...
          (this._validateUserOn = function (t, n) {
            'string' == typeof t &&
              (('source' === t && e._hasRegisteredListener('paymentmethod')) ||
                ('paymentmethod' === t && e._hasRegisteredListener('source'))) &&
          ...
          (this.canMakePayment = sn(function () {
            if ((e._report('pr.can_make_payment'), e._canMakePaymentResolved)) {
              var t =
                null !== e._activeBackingLibrary
                  ...
                  : null
              return (
                e._report('pr.can_make_payment_response', {response: t, cached: !0}),
                Ne.resolve(t)
              )
            }
            ...
            return uo(n, function (t) {
              ...
              var o = null
              return (
                'SATISFIED' === t.type && (o = e._constructCanMakePaymentResponse()),
          ...
          (this.show = sn(function () {
            ...
            if (!e._activeBackingLibrary)
              throw (
                ...
                new ke('Payment Request is not available in this browser.'))
              )
            var t = e._activeBackingLibrary
            e._report('pr.show', {listeners: Object.keys(e._callbacks).sort()}),
              (e._isShowing = !0),
              t.show()
          })),
      ...
      qa = {
        ...
        error: Qe(vt({type: ot, code: Qe(ot), decline_code: Qe(ot), param: Qe(ot)})),
        locale: _t('elements()'),
        fonts: _t('elements()'),
        placeholder: Qe(ot),
        disabled: Qe(it),
      ...
      za = function (e, t, n) {
        if ((Ha(e, n), gr[e].unique && -1 !== t.indexOf(e)))
          throw new ke('Can only create one Element of type ' + e + '.')
        var r = gr[e].conflict,
          o = je(t, r)
        if (o.length) {
          var a = o[0]
      ...
      Wa = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '1.2em',
          t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ga,
        ...
        return (
          ...
          Ja(t, [
                ...
                if (e) {
                  ...
                  if ((t && (n = document.querySelector("label[for='" + t + "']")), n))
                    ...
                    for (n = n || e.parentElement; n && 'LABEL' !== n.nodeName; )
                      n = n.parentElement
                  n
                    ? ((this._label = n), n.addEventListener('click', this.focus))
                    : e.addEventListener('click', this.focus)
                }
              },
            },
            ...
            },
            {
              key: '_emitEvent',
              value: function (e, t) {
                return this._emit(e, Va({elementType: this._componentName}, t))
              },
            },
            {
              key: '_setupEvents',
              value: function () {
                ...
                this._frame._on('redirectfocus', function (t) {
                  ...
                  this._frame._on('blur', function () {
                    ;(e._focused = !1),
                      ...
                      e._lastSubmittedAt &&
                        ...
                        (e._controller.report('payment_request_button.sheet_visible', {
                  ...
                  this._frame._on('autofill-cleared', function () {
                    ;(e._autofilled = !1),
                      e._parent &&
                        (e._parent.style.backgroundColor = e._lastBackgroundColor),
                      e._updateClasses()
                  })
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if ('paymentRequestButton' === this._componentName) {
                  ...
                  ;(t || o) &&
                    (this._frame.updateStyle({height: o || this._lastHeight || '40px'}),
        ...
        ;(this._paymentRequest = null),
          ...
          (this.update = sn(function (t) {
            ...
            if (
              ...
              var o = r.classes,
                a = X(r, ['classes'])
              o && (e._removeClasses(), e._computeCustomClasses(o), e._updateClasses()),
                e._updateFrameHeight(r),
                Object.keys(a).length &&
                  (e._frame.update(a), e._secondaryFrame && e._secondaryFrame.update(a))
            }
            return e
          })),
      ...
      ai = {locale: Qe(ot), fonts: Qe(ft(dt)), betas: Qe(ft(tt.apply(void 0, oe(Br))))},
      ii = vt(ai),
      ci = function e(t, n) {
        var r = this
        ...
        var s = c
            ...
            .map(function (e) {
              return oi({}, e, {__resolveFontRelativeTo: window.location.href})
            }),
          u = c
            .map(function (e) {
              return e.cssSrc
            ...
            if ('string' == typeof e) {
              ...
              co(e)
                .then(function (n) {
                  ...
                  r._controller.action.updateCSSFonts({fonts: o, groupId: r._id}),
                    (r._commonOptions = oi({}, r._commonOptions, {
                      fonts: [].concat(
                        oe(r._commonOptions.fonts ? r._commonOptions.fonts : []),
                        oe(o),
                      ),
                    }))
                })
      ...
      si = function () {
        ...
        ;(this.getElement = sn(function (t) {
          ...
          (this.create = un(function (t, n) {
            ...
            var a = oi({}, o, e._commonOptions, {componentName: t, groupId: e._id}),
      ...
      mi =
        ((Pe = {}),
        ae(Pe, Mt.auBankAccount, _i.au_becs_debit),
        ae(Pe, Mt.card, _i.card),
        ae(Pe, Mt.cardNumber, _i.card),
        ae(Pe, Mt.cardExpiry, _i.card),
        ae(Pe, Mt.cardCvc, _i.card),
        ae(Pe, Mt.postalCode, _i.card),
        ae(Pe, Mt.iban, _i.sepa_debit),
        ae(Pe, Mt.idealBank, _i.ideal),
        ae(Pe, Mt.fpxBank, _i.fpx),
        Pe),
      yi = function (e) {
      ...
      Ii = function (e, t) {
        ...
        if ('object' !== (void 0 === e ? 'undefined' : Ai(e)))
          return Ve('object', void 0 === e ? 'undefined' : Ai(e), t)
        var n = e.client_secret,
          r = e.status,
          o = e.next_action,
          a = Ti(n, bt(t, 'client_secret'))
        if ('error' === a.type) return a
        if ('string' != typeof r)
          return Ve('string', void 0 === r ? 'undefined' : Ai(r), bt(t, 'status'))
        if (
          ('requires_source_action' === r || 'requires_action' === r) &&
          'object' !== (void 0 === o ? 'undefined' : Ai(o))
        )
          return Ve('object', void 0 === o ? 'undefined' : Ai(o), bt(t, 'next_action'))
      ...
      Ri = function (e) {
        return function (t, n) {
          if ('object' !== (void 0 === t ? 'undefined' : Ai(t)))
            return Ve('object', void 0 === t ? 'undefined' : Ai(t), n)
          ...
          if (null === e) {
            if ('string' != typeof r)
              return Ve('string', void 0 === r ? 'undefined' : Ai(r), bt(n, 'type'))
            a = r
          } else {
            if (void 0 !== r && r !== e)
              return 'string' != typeof r
                ? Ve('string', void 0 === r ? 'undefined' : Ai(r), bt(n, 'type'))
                : Ve('"' + r + '"', '"' + e + '"', bt(n, 'type'))
            a = e
          }
          ...
          if (
            ...
            'object' !== (void 0 === c ? 'undefined' : Ai(c)))
          )
            return Ve('object or element', Ai(t[a]), bt(n, a))
      ...
      Ni = function (e) {
        return function (t, n) {
          ...
          var r = t.card,
            o = ce(t, ['card'])
          if (!r || 'object' !== (void 0 === r ? 'undefined' : Ai(r))) return We(t)
          var a = r.cvc,
            i = ce(r, ['cvc'])
          if (null == a) return We(t)
          var c = hi(a),
            s = c ? c._componentName : ''
          return Mt.cardCvc !== s
            ? Ve(
                '`' + Mt.cardCvc + '` Element',
                s ? '`' + s + '` Element' : void 0 === a ? 'undefined' : Ai(a),
                bt(n, e + '.cvc'),
              )
            : We(ki({}, o, {card: ki({}, i, {cvc: c})}))
        }
      },
      Ci = at(
        vt({
      ...
      Mi = function (e, t) {
        return function (n, r) {
          ...
          if ('object' !== (void 0 === n ? 'undefined' : Ai(n)))
            return Ve('object', void 0 === n ? 'undefined' : Ai(n), r)
          ...
          if (null != a)
            throw new ke(t + ': Expected payment_method, or source, not source_data.')
          if (null != i)
            throw new ke(
              t + ': Expected payment_method, or source, not payment_method_data.',
            )
          if (null != o && null != s)
            throw new ke(t + ': Expected either payment_method or source, but not both.')
          if (null != o)
            return 'string' != typeof o
              ? Ve('string', void 0 === o ? 'undefined' : Ai(o), bt(r, 'source'))
              : We({
                  source: o,
                  paymentMethodData: null,
                  paymentMethodOptions: null,
          ...
          if (
            null != s &&
            'string' != typeof s &&
            'object' !== (void 0 === s ? 'undefined' : Ai(s))
          )
            return Ve(
              'string or object',
              void 0 === s ? 'undefined' : Ai(s),
              bt(r, 'payment_method'),
            )
          var l = gt(Ni(e), c, t, {
          ...
          if ('object' === (void 0 === s ? 'undefined' : Ai(s)) && null !== s) {
            var p = gt(Ri(e), s, t, {path: [].concat(ie(r.path), ['payment_method'])})
      ...
      qi = '__privateStripeMetricsController',
      Di = {MERCHANT: 'merchant', SESSION: 'session'},
      Bi = (function () {
        function e() {
          var t = this,
          ...
          if ((se(this, e), n.checkoutIds)) {
            ...
            (this._muid = this._getID(Di.MERCHANT)),
              (this._sid = this._getID(Di.SESSION)),
              (this._doNotPersist = !1)
          ;(this._id = Gt(qi)),
            (this._controllerFrame = new On(At.METRICS_CONTROLLER, this._id, {
              autoload: !0,
                ...
                setInterval(function () {
                  ...
                  n !== t &&
                    (e.send({
                      action: 'ping',
                      payload: {
                        sid: e._getID(Di.SESSION),
                        muid: e._getID(Di.MERCHANT),
              ...
              value: function (e, t) {
                try {
                  this.send({
                    action: 'track',
                    payload: {
                      sid: this._getID(Di.SESSION),
                      muid: this._getID(Di.MERCHANT),
                      url: document.location.href,
                      source: e,
                      data: t,
                    },
      ...
      Hi = function (e) {
        if (!e || 'object' !== (void 0 === e ? 'undefined' : Ui(e))) return null
        var t = e.type,
          n = ue(e, ['type'])
      ...
      Gi = {source: vt({id: Ze('src_'), client_secret: Ze('src_client_secret_')})},
      Yi = vt(Gi),
      Wi = function (e) {
        switch (e.type) {
          case 'object':
      ...
      Ki = function (e) {
        return Et(Ri(null), e, 'createPaymentMethod').value
      },
      Vi = function (e, t, n, r, o) {
        ...
        if (s && n !== s)
          return Ne.reject(
            new ke('The type supplied in payment_method_data is not consistent.'),
          )
        if (a) {
          var l = a._frame.id,
            p = a._componentName
      ...
      Ji = function (e, t, n, r, o) {
        if ('string' == typeof n) return Vi(e, t, n, r, o)
        try {
          var a = Ki(n),
            i = a.element,
            c = a.type,
      ...
      Xi = function (e, t) {
        return Et(Ti, e, 'stripe.' + t + ' intent secret').value
      },
      $i = function (e, t) {
        return Et(Ci, t, e).value
      },
      Zi = function (e, t, n) {
        ...
        if (null != a && (null != i || null != s))
          throw new ke(t + ': Expected either source or payment_method, but not both.')
        return i
          ? i.element
            ? {
                confirmMode: {
          ...
          : a
          ? {confirmMode: {tag: 'source', source: a}, otherParams: u}
          ...
          switch (r.type) {
            case 'stripe_3ds2_fingerprint':
              return {
                ...
                optimizations: ec(r.three_ds_optimizations, n),
            ...
            case 'stripe_3ds2_challenge':
              return {
                ...
                optimizations: ec(r.stripe_js.three_ds_optimizations, n),
      ...
      ac = function (e, t, n, r, o) {
        return t === Lt.PAYMENT_INTENT
          ? n.action
              .cancelPaymentIntentSource({intentSecret: e, locale: o, sourceId: r})
              .then(rc)
          : n.action
              .cancelSetupIntentSource({intentSecret: e, locale: o, sourceId: r})
              .then(rc)
      },
      ic = (function () {
        function e(e, t) {
      ...
      sc = function (e, t, n, r, o) {
        return e.createLightboxFrame(
          ...
          cc({url: t, locale: o, intentId: n}, r ? {source: r} : {}),
        )
      },
      uc = function (e, t, n, r, o) {
        var a = xr(),
          i = Date.now(),
          c = sc(r, e.url, t.id, e.source, o)
        c.show(),
          r.report('authorize_with_url.loading', {viewport: a, intentId: t.id}),
          c._on('load', function () {
          ...
          new Ne(function (a, u) {
            ...
            l &&
              c._once('cancel', function () {
                c.fadeOutBackdrop(),
                  Ne.all([ac(t, n, r, l, o), c.destroy()]).then(function (e) {
                    var t = ic(e, 1),
                      n = t[0]
                    return a(n)
                  })
              ...
              c._once('authorize_with_url_done', function (e) {
                ...
                var u = function () {
                  return Ne.all([oc(t, n, r, o), c.destroy()]).then(function (e) {
                    return ic(e, 1)[0]
                  })
                }
                'fallback' === e.type
      ...
      _c = function (e, t, n, r, o) {
        return t.optimizations.skipFingerprint
          ...
          : '' === t.methodUrl
          ? (n.report('3ds2.fingerprint.no_method_url', {hosted: r, intentId: e.id}),
            Ne.resolve({fingerprintAttempted: !1, fingerprintData: null}))
          : fc(n, e.id, r, o).then(function (e) {
              return e.action
      ...
      mc = function (e, t, n, r, o, a) {
        var i = Date.now(),
          c = hc(e.id, r, n.cardBrand, a, o),
          s = function (i) {
            var s = !0
            return new Ne(function (u) {
              c.then(function (c) {
                c._once('cancel', function () {
                  c.fadeOutBackdrop(),
                    ac(e, t, r, n.threeDS2Source, o).then(function (e) {
                      ;(s = !1), u(e)
                    })
                }),
                ...
                c.action
                  .perform3DS2Challenge(
                    pc({}, p, {shouldSandbox: l.sandboxChallengeFrame}),
                  )
                  .then(function () {
                    ;(s = !1), u()
                  })
                !(function n() {
                  oc(e, t, r, o).then(function (e) {
                    if (s) {
                      if (e.error) {
                        var t = e.error,
            ...
            return Ne.all([
              ...
              return (
                r.report(
                  '3ds2.done',
                  pc(
                    {intentId: e.id, hosted: a, totalDuration: Date.now() - i},
            ...
            return _c(e, n, r, a, o)
              ...
              .then(function (t) {
                ...
                return 'C' !== o.transStatus
                  ? (r.report('3ds2.frictionless', {hosted: a, intentId: e.id}), l())
                  : s({
                      type: '3ds2-challenge',
                      threeDS2Source: n.threeDS2Source,
      ...
      yc = function (e) {
        return new Ne(function (t, n) {
          var r = setTimeout(function () {
            t({
              type: 'error',
              error: {code: 'redirect_error', message: 'Failed to redirect to ' + e},
              locale: 'en',
            })
          }, 3e3)
      ...
      bc = function (e, t, n, r) {
        return yc(n).then(function (n) {
          return vc(r, t + ' redirect', n), gi(n, e)
        })
      },
      gc =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
      ...
      wc = function (e, t, n, r, o) {
        ...
        switch (a.type) {
          case '3ds1-modal':
            return uc(a, i, Lt.PAYMENT_INTENT, e, r)
          case '3ds2-fingerprint':
          case '3ds2-challenge':
            return mc(i, Lt.PAYMENT_INTENT, a, e, r, o)
          case 'redirect':
            return bc(t, n, a.redirectUrl, e)
          case 'oxxo-display':
            throw new ke(
      ...
      Sc = function (e, t, n, r, o) {
        return wc(e, t, n, r, o).then(function (e) {
        ...
        return function (n, r, o, a, i) {
          var c = Xi(o, e),
            ...
            p = n.action.confirmPaymentIntent(
              Oc({}, s, {intentSecret: c, expectedType: t, options: u, mids: r}),
            )
          return u.handleActions ? p.then(Pc(n, t, l, !1)) : p.then(gi)
        }
      },
      Ac = kc('confirmAuBecsDebitPayment', _i.au_becs_debit),
      Tc = kc('confirmBancontactPayment', _i.bancontact),
      Ic = kc('confirmCardPayment', _i.card),
      Rc = kc('confirmBacsDebitPayment', _i.bacs_debit),
      Nc = kc('confirmFpxPayment', _i.fpx),
      Cc = kc('confirmEpsPayment', _i.eps),
      Mc = kc('confirmGiropayPayment', _i.giropay),
      jc = kc('confirmGrabPayPayment', _i.grabpay),
      Lc = kc('confirmIdealPayment', _i.ideal),
      xc = kc('confirmOxxoPayment', _i.oxxo),
      qc = kc('confirmP24Payment', _i.p24),
      Dc = kc('confirmSepaDebitPayment', _i.sepa_debit),
      Bc = kc('confirmSofortPayment', _i.sofort),
      Fc = function (e, t) {
        var n = Xi(e, 'retrievePaymentIntent')
        return t.action.retrievePaymentIntent({intentSecret: n, hosted: !1}).then(gi)
      },
      Uc = function (e, t) {
        var n = Xi(e, 'handleHosted3DS2Setup [internal]')
        return t.action
          .retrievePaymentIntent({intentSecret: n, hosted: !0})
          .then(Pc(t, _i.card, !1, !0))
      },
      Hc = function (e, t) {
        var n = Xi(e, 'handleCardAction')
        return t.action
            ...
            switch (n.type) {
              ...
              case 'object':
                ...
                if (Pi(r.status)) {
                  ...
                  return Sc(t, r, _i.card, n.locale, !1)
                }
                throw new ke(
      ...
      Kc = function (e) {
        return function (t, n) {
          if ('object' === (void 0 === t ? 'undefined' : Gc(t)) && null !== t) {
            var r = t.source,
              o = t.source_data,
              a = t.payment_method,
            ...
            if (null != r && 'string' != typeof r)
              return Ve('string', void 0 === r ? 'undefined' : Gc(r), bt(n, 'source'))
            if (null != a && 'string' != typeof a)
              return Ve(
                'string',
                void 0 === a ? 'undefined' : Gc(a),
                bt(n, 'payment_method'),
              )
            if (null != o && 'object' !== (void 0 === o ? 'undefined' : Gc(o)))
              return Ve(
                'object',
                void 0 === o ? 'undefined' : Gc(o),
                bt(n, 'source_data'),
              )
            if (null != i && 'object' !== (void 0 === i ? 'undefined' : Gc(i)))
              return Ve(
                'object',
                void 0 === i ? 'undefined' : Gc(i),
                bt(n, 'payment_method_data'),
              )
            var s = Yc(o, bt(n, 'source_data'))
            if ('error' === s.type) return s
            var u = s.value,
              l = Yc(i, bt(n, 'payment_method_data'))
            if ('error' === l.type) return l
            var p = l.value
            return We({
              sourceData: u,
          ...
          return null === t
            ? Ve('object', 'null', n)
            : Ve('object', void 0 === t ? 'undefined' : Gc(t), n)
        }
      },
      Vc = function (e) {
        return function (t, n) {
          ...
          if ('object' !== (void 0 === t ? 'undefined' : Gc(t)))
            return Ve('object', void 0 === t ? 'undefined' : Gc(t), n)
          if (null === t) return Ve('object', 'null', n)
          if (e) {
            if (!t.payment_intent)
              return We({
            ...
            return Kc(o)(r, bt(n, 'payment_intent'))
          }
      ...
      Jc = function (e, t, n, r, o, a) {
        ...
        return E
          ? {confirmMode: zc({tag: 'source-from-element'}, S), otherParams: h}
          : {
              confirmMode: zc({tag: 'paymentMethod-from-element', options: null}, S),
              otherParams: h,
            }
      },
      Qc = function (e, t, n, r, o, a) {
        ...
        if (null !== u && null !== s)
          throw new ke(r + ': Expected either source or source_data, but not both.')
        if (null !== p && null !== l)
          throw new ke(
            r + ': Expected either payment_method or payment_method_data, but not both.',
          )
        if (null !== p && null !== u)
          throw new ke(r + ': Expected either payment_method or source, but not both.')
        if (s || l) {
          var f = s || l || {},
            h = f.type,
            _ = f.data,
            ...
            y = Wc(n, h, r, m)
          return m
            ? {confirmMode: {tag: 'source-from-data', type: y, data: _}, otherParams: d}
            : {
                confirmMode: {
                  tag: 'paymentMethod-from-data',
                  type: y,
      ...
      Zc = function (e, t, n, r, o, a) {
        var i = Et(Ti, r, 'stripe.confirmPaymentIntent intent secret'),
          c = i.value,
          s = Xc(e, !1, null, 'confirmPaymentIntent')(o, a)
        return t.action
      ...
      es = function (e, t, n, r, o, a, i) {
        var c = Et(Ti, o, 'stripe.handleCardPayment intent secret'),
          s = c.value,
          u = _i.card,
          l = Xc(e, r, u, 'handleCardPayment')(a, i),
          p = !a && !i
        return t.action
          .confirmPaymentIntent(
            $c({}, l, {
      ...
      ts = function (e, t, n, r, o, a) {
        var i = Et(Ti, r, 'stripe.handleSepaDebitPayment intent secret'),
          c = i.value,
          s = _i.sepa_debit,
          u = Xc(!1, n, s, 'handleSepaDebitPayment')(o, a),
          l = !o && !a
        return e.action
          .confirmPaymentIntent(
            $c({}, u, {
      ...
      ns = function (e, t, n, r, o, a, i) {
        var c = Et(Ti, o, 'stripe.handleIdealPayment intent secret'),
          s = c.value,
          u = _i.ideal,
          l = Xc(e, r, u, 'handleIdealPayment')(a, i),
          p = !a && !i
        return t.action
          .confirmPaymentIntent(
            $c({}, l, {
      ...
      rs = function (e, t, n, r, o, a) {
        var i = Et(Ti, r, 'stripe.handleFpxPayment intent secret'),
          c = i.value,
          s = _i.fpx,
          u = Xc(!1, n, s, 'handleFpxPayment')(o, a),
          l = !o && !a
        return e.action
          .confirmPaymentIntent(
            $c({}, u, {
      ...
      os = function (e, t, n, r, o) {
        ...
        switch (a.type) {
          case '3ds1-modal':
            return uc(a, i, Lt.SETUP_INTENT, e, r)
          case '3ds2-fingerprint':
          case '3ds2-challenge':
            return mc(i, Lt.SETUP_INTENT, a, e, r, o)
          default:
            return Ne.resolve({setupIntent: t})
        }
      },
      as = function (e, t, n, r, o) {
        return os(e, t, n, r, o).then(function (e) {
        ...
        return function (n, r, o, a, i) {
          var c = Xi(o, e),
            ...
            p = n.action.confirmSetupIntent(
              cs({}, s, {intentSecret: c, expectedType: t, options: u, mids: r}),
            )
          return u.handleActions ? p.then(is(n, t, l, !1)) : p.then(Ei)
        }
      },
      us = ss('confirmCardSetup', _i.card),
      ls = ss('confirmSepaDebitSetup', _i.sepa_debit),
      ps = ss('confirmAuBecsDebitSetup', _i.au_becs_debit),
      ds = ss('confirmBacsDebitSetup', _i.bacs_debit),
      fs = function (e, t) {
        var n = Xi(e, 'retrieveSetupIntent')
        return t.action.retrieveSetupIntent({intentSecret: n, hosted: !1}).then(Ei)
      },
      hs = function (e, t) {
        var n = Xi(e, 'handleHosted3DS2Setup [internal]')
        return t.action
          .retrieveSetupIntent({intentSecret: n, hosted: !0})
          .then(is(t, _i.card, !1, !0))
      },
      _s =
        Object.assign ||
        function (e) {
      ...
      ms = function (e, t, n, r, o) {
        var a = Et(Ti, n, 'stripe.handleCardSetup intent secret'),
          i = a.value,
          c = _i.card,
          s = Xc(!1, !1, c, 'handleCardSetup')(r, o),
          u = !r && !o
        return e.action
          .confirmSetupIntent(
            _s({}, s, {
      ...
      ys = function (e, t, n, r, o) {
        var a = Et(Ti, n, 'stripe.handleSepaDebitSetup intent secret'),
          i = a.value,
          c = _i.sepa_debit,
          s = Xc(!1, !1, c, 'handleSepaDebitSetup')(r, o),
          u = !r && !o
        return e.action
          .confirmSetupIntent(
            _s({}, s, {
      ...
      vs = function (e, t, n, r, o) {
        var a = Et(Ti, n, 'stripe.confirmSetupIntent intent secret'),
          i = a.value,
          c = Xc(!1, !1, null, 'confirmSetupIntent')(r, o)
        return e.action
          .confirmSetupIntent(
            _s({}, c, {
              otherParams: _s({}, c.otherParams),
              intentSecret: i,
              expectedType: null,
              options: {handleActions: !1},
              mids: t,
      ...
      bs = [Dr.checkout_beta_2, Dr.checkout_beta_3, Dr.checkout_beta_4],
      gs = [
        Dr.checkout_beta_2,
        Dr.checkout_beta_3,
        Dr.checkout_beta_4,
        Dr.checkout_beta_locales,
        Dr.checkout_beta_testcards,
      ],
      Es = {
        da: 'da',
        de: 'de',
      ...
      ks = {
        ...
        locale: Qe(et.apply(void 0, ['auto'].concat(fe(Ss)))),
        customerEmail: Qe(ot),
      ...
      Is = function (e, t, n) {
        var r = yt(
            Os(
              ...
              -1 !== e.indexOf('checkout_beta_locales')
                ? {locale: Qe(et.apply(void 0, ['auto'].concat(fe(Ss), fe(Ps))))}
                : {},
            ),
          ),
        ...
        return Os({tag: 'no-session', items: c, successUrl: s, cancelUrl: u}, l)
      },
      Rs = function (e, t, n) {
        var r = Is(e, t, n)
        if ('no-session' === r.tag) {
      ...
      xs = function (e, t) {
        var n = function (t) {
          return vc(e, 'redirectToCheckout', t), {error: t.error}
        }
        return yc(t).then(n)
      },
      qs = function (e, t, n, r) {
        return function (o) {
          ...
          var a = js(t, r, o, e.livemode())
          if ('session' === a.tag) {
            var i = a,
              c = i.sessionId
            return e.action
              .createPaymentPageWithSession({betas: t, mids: n(), sessionId: c})
              .then(function (t) {
      ...
      Fs = function (e) {
        return 'object' === (void 0 === e ? 'undefined' : Ds(e)) && null !== e ? e : {}
      },
      Us = function (e, t, n) {
        var r = hi(t)
        if (r && 'cardCvc' === r._componentName) {
          var o = r._frame.id
          return e.action.tokenizeCvcUpdate({frameId: o, mids: n}).then(Bs)
        }
        throw new ke(
        ...
        return function (n, r) {
          ...
          if (o) {
            var a = o._frame.id,
              ...
              c = Fs(r)
            return e.action
              .tokenizeWithElement({frameId: a, elementName: i, tokenData: c, mids: t})
              .then(Bs)
          }
          if ('string' == typeof n) {
            var s = n,
              u = Fs(r)
            return e.action
              .tokenizeWithData({elementName: null, type: s, tokenData: u, mids: t})
              .then(Bs)
          }
          throw new ke(
      ...
      Gs = function (e, t) {
        return e.action.createRadarSession({mids: t}).then(zs)
      },
      Ys =
        Object.assign ||
        function (e) {
      ...
      Xs = (function () {
        function e(t, n) {
          var r = this
          _e(this, e), $s.call(this)
          var o = Et(Vs, t || {}, 'Stripe()'),
            a = o.value,
            i = o.warnings,
            c = a.apiKey,
            s = a.stripeAccount,
          ...
          p && p.mids && (e._ec = new Fi({checkoutIds: p.mids})),
            (this._apiKey = c),
            (this._keyMode = Ue(c)),
            (this._locale = u || null),
            (this._betas = h || []),
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ;(this.confirmCardSetup = ln(function () {
                  ...
                  (this.confirmBancontactPayment = Qs('confirmBancontactPayment')),
                  ...
                  (this.confirmGiropayPayment = Qs('confirmGiropayPayment')),
                  ...
                  (this.confirmGrabPayPayment = Qs('confirmGrabPayPayment')),
                  ...
                  (this.confirmOxxoPayment = Qs('confirmOxxoPayment')),
                  ...
                  (this.confirmP24Payment = Qs('confirmP24Payment')),
                  ...
                  (this.confirmEpsPayment = Qs('confirmEpsPayment')),
                  ...
                  (this.confirmSofortPayment = Qs('confirmSofortPayment')),
                  Fr(this._betas, Dr.sofort_pm_beta_1) &&
                    (this.confirmSofortPayment = ln(function () {
                      for (var e = arguments.length, t = Array(e), o = 0; o < e; o++)
                        t[o] = arguments[o]
                ...
                var t = this,
                  ...
                  o = ln(function () {
                    for (var e = arguments.length, n = Array(e), o = 0; o < e; o++)
                      n[o] = arguments[o]
                    return Zc.apply(void 0, [!0, t._controller, r()].concat(n))
                  }),
                  a = ln(function () {
                    for (var e = arguments.length, n = Array(e), o = 0; o < e; o++)
                      n[o] = arguments[o]
                    return Zc.apply(void 0, [!1, t._controller, r()].concat(n))
                  }),
                  i = Nn(es, Js('handleCardPayment')),
                  c = ln(function () {
                  ...
                  p = ln(function () {
                    for (var e = arguments.length, n = Array(e), o = 0; o < e; o++)
                      n[o] = arguments[o]
                    return vs.apply(void 0, [t._controller, r()].concat(n))
                  }),
                  d = ln(function () {
                    for (var e = arguments.length, o = Array(e), a = 0; a < e; a++)
                      o[a] = arguments[a]
                    return ts.apply(void 0, [t._controller, r(), n].concat(o))
                  }),
                  f = ln(function () {
                    for (var e = arguments.length, n = Array(e), o = 0; o < e; o++)
                      n[o] = arguments[o]
                    return ys.apply(void 0, [t._controller, r()].concat(n))
                  }),
                  h = ln(function () {
                    for (var e = arguments.length, o = Array(e), a = 0; a < e; a++)
                      o[a] = arguments[a]
                    return ns.apply(void 0, [!0, t._controller, r(), n].concat(o))
                  }),
                  _ = ln(function () {
                    for (var e = arguments.length, o = Array(e), a = 0; a < e; a++)
                      o[a] = arguments[a]
                    return ns.apply(void 0, [!1, t._controller, r(), n].concat(o))
                  }),
                  m = ln(function () {
                    for (var e = arguments.length, o = Array(e), a = 0; a < e; a++)
                      o[a] = arguments[a]
                    return rs.apply(void 0, [t._controller, r(), n].concat(o))
                  })
                ;(this.handleCardPayment = s),
                  (this.confirmPaymentIntent = a),
                  (this.handleCardSetup = l),
                  (this.confirmSetupIntent = p),
                  (this.fulfillPaymentIntent = Qs('fulfillPaymentIntent')),
                  (this.handleSepaDebitPayment = Qs('handleSepaDebitPayment')),
                  (this.handleSepaDebitSetup = Qs('handleSepaDebitSetup')),
                  (this.handleIdealPayment = Qs('handleIdealPayment')),
                  (this.handleFpxPayment = Qs('handleFpxPayment')),
                  Fr(this._betas, Dr.payment_intent_beta_1)
                  ...
                  Fr(this._betas, Dr.sepa_pm_beta_1) &&
                    ((this.handleSepaDebitPayment = d), (this.handleSepaDebitSetup = f))
              },
            },
            {
                ...
                e &&
                  (this.tryNextAction = un(function (e, n) {
                    ...
                    return 'payment_intent' === o.object
                      ? Sc(t._controller, o, c, 'auto', !1)
                      : as(t._controller, o, c, 'auto', !1)
                  }))
              },
            },
            {
              ...
              value: function (e) {
                var t = this,
                  ...
                  r = e.reduce(function (e, t) {
                    var n = Ce(gs, function (e) {
                      return e === t
                    })
                    return n ? [].concat(me(e), [n]) : e
                  }, [])
                this.redirectToCheckout = qs(this._controller, r, n, this._locale)
              },
            },
            {
              key: '_ensureHTTPS',
    ...
    var $s = function () {
        ...
        ;(this.elements = sn(function (t) {
          return new ui(
            e._controller,
            Ys({}, e._locale ? {locale: e._locale} : {}, t, {betas: e._betas}),
          )
        })),
          (this.createToken = un(function (t, n) {
            var r = e._mids()
            if ('cvc_update' === t) {
              if (Fr(e._betas, Dr.cvc_update_beta_1)) return Us(e._controller, n, r)
              throw new ke(
                "You cannot create a 'cvc_update' token without using the 'cvc_update_beta_1' beta flag.",
              )
            }
            return Hs(e._controller, r)(t, n)
          })),
          (this.createSource = un(function (t, n) {
            ...
            if (r) {
              ...
              return !o && yi(u)
                ? Ne.reject(
                    new ke('Please provide Source creation parameters to createSource.'),
                  )
                : e._controller.action
            ...
            return o
              ? i
                ? e._controller.action
                    ...
                    .then(zi)
                : Ne.reject(new ke('Please provide a source type to createSource.'))
              : Ne.reject(
                  new ke(
          ...
          (this.retrieveSource = sn(function (t) {
            var n = Et(Yi, {source: t}, 'retrieveSource'),
              r = n.value
            return (
              n.warnings.forEach(function (t) {
                return e._controller.warn(t)
              }),
              e._controller.action.retrieveSource(r).then(zi)
            )
          })),
      ...
      ru = function (e, t) {
        return new Zs(
          tu(
            {apiKey: e},
            t && 'object' === (void 0 === t ? 'undefined' : eu(t)) ? t : {},
          ),
          nu,
        )
      }
    ;(ru.version = Zs.version),
      window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3
        ? (window.Stripe.StripeV3 = ru)
        : window.Stripe
        ? window.console &&
          console.warn(
