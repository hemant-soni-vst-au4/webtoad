...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxY2PlayerComponent", function() { return NgxY2PlayerComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxY2PlayerModule", function() { return NgxY2PlayerModule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y2PlayerService", function() { return Y2PlayerService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getIdFromYoutubeUrl", function() { return getIdFromYoutubeUrl; });
...
class Y2PlayerService {
    ...
    ready() {
         ...
         * @return {?}
         */
        state => state === true)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1));
    }
    /**
     * @param {?} elm
     * @return {?}
...
/** @nocollapse */ Y2PlayerService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"])({ factory: function Y2PlayerService_Factory() { return new Y2PlayerService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"]), Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["RendererFactory2"])); }, token: Y2PlayerService, providedIn: "root" });
...
function resizeObservable(elm, cb, time = 200) {
     ...
     * @return {?}
     */
    () => cb())), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])((/**
     * @return {?}
     */
    () => {
...
class NgxY2PlayerComponent {
    ...
    loadYoutube() {
         ...
         * @return {?}
         */
        id => this._y2.ready().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mapTo"])(id)))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((/**
         * @param {?} id
         * @return {?}
         */
        id => {
...
NgxY2PlayerComponent.propDecorators = {
    playerOptions: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['playerOptions',] }],
    containerElm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['container',] }],
    videoUrl: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['videoUrl',] }],
    videoId: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['videoId',] }],
    onReady: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['ready',] }],
    onStateChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['stateChange',] }],
    onPlaybackQualityChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['playbackQualityChange',] }],
    onPlaybackRateChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['playbackRateChange',] }],
    onError: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['error',] }],
    onApiChange: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ['apiChange',] }]
};
...
//# sourceMappingURL=default~dashboard-lessons-lesson-details-lesson-details-module~dashboard-lessons-my-courses-course-d~113bbb17-es2015.js.map