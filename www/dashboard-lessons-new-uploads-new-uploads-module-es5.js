(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-lessons-new-uploads-new-uploads-module"], {
    ...
    /***/
    function BB7H(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NewUploadsPageModule", function () {
        return NewUploadsPageModule;
      });
      /* harmony import */
      ...
      var _new_uploads_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./new-uploads.page */
      "NaL6");
      ...
      var NewUploadsPageModule = function NewUploadsPageModule() {
        _classCallCheck(this, NewUploadsPageModule);
      };

      NewUploadsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
    ...
    /***/
    function NaL6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NewUploadsPage", function () {
        return NewUploadsPage;
      });
      /* harmony import */
      ...
      var _raw_loader_new_uploads_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./new-uploads.page.html */
      "51GO");
      /* harmony import */


      var _new_uploads_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./new-uploads.page.scss */
      "qwXd");
      /* harmony import */
      ...
      var _services_lessons_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./../../../services/lessons.service */
      "s1uX");
      /* harmony import */
      ...
      var NewUploadsPage = /*#__PURE__*/function () {
        function NewUploadsPage(router, sharedService, onBoardingService, navController, lessonsService, globalService) {
          _classCallCheck(this, NewUploadsPage);
        ...
        _createClass(NewUploadsPage, [{
          ...
          value: function getUserProfile() {
            ...
            try {
              this.onBoardingService.getUserProfile().subscribe(function (res) {
                ...
                if (_this.profile) {
                  if (_this.profile.userLevelId === '5b117087602e39d075e7cfcc') {
                    _this.userLevel = 'Elementary';
                  } else if (_this.profile.userLevelId === '5b117088602e39d075e7cfcd') {
                    _this.userLevel = 'Advanced';
                  } else {
                    _this.userLevel = 'Intermediate';
                  }

                  _this.getNewUploadsLessons();
                }
              }, function (error) {});
            } catch (error) {
              console.log(error);
          ...
          value: function getNewUploadsLessons(event) {
            var _this2 = this;
            ...
            try {
              this.lessonsService.getNewUploadsLessons(this.nextPage).subscribe(function (res) {
                if (_this2.nextPage === 1) {
                  _this2.newUploadsLessons = [];
                }
                ...
                if (res.data.length) {
                  res.data.forEach(function (ele) {
                    ...
                    _this2.newUploadsLessons.push(ele);
                  });
                  _this2.nextPage++;
                ...
                _this2.isNewUploadLessons = false;
              }, function (error) {});
            } catch (error) {
              this.isNewUploadLessons = false;
              console.log(error);
          ...
          value: function loadData(event) {
            ...
            setTimeout(function () {
              if (_this3.nextPage === _this3.total) {
                event.target.disabled = true;
              }

              _this3.isNewUploadLessons = true;

              _this3.getNewUploadsLessons(event);
            }, 500);
          }
        }]);
      ...
      NewUploadsPage.ctorParameters = function () {
        return [{
      ...
      NewUploadsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"], _services_shared_service__WEBPACK_IMPORTED_MODULE_7__["SharedService"], _services_on_boarding_service__WEBPACK_IMPORTED_MODULE_3__["OnBoardingService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"], _services_lessons_service__WEBPACK_IMPORTED_MODULE_5__["LessonsService"], _global_global_service__WEBPACK_IMPORTED_MODULE_4__["GlobalService"]])], NewUploadsPage);
      /***/
    },
    ...
    /***/
    function qwXd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=dashboard-lessons-new-uploads-new-uploads-module-es5.js.map