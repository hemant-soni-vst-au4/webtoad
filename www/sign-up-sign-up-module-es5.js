  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sign-up-sign-up-module"], {
    ...
    function v2PJ(module, __webpack_exports__, __webpack_require__) {
      ...
      var SignUpPage = /*#__PURE__*/function () {
        function SignUpPage(formBuilder, sharedService, navController, authService, router) {
        ...
        _createClass(SignUpPage, [{
          ...
          value: function ngOnInit() {
            this.signUpForm = this.formBuilder.group({
              ...
              confirmEmail: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern('^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:.[a-zA-Z0-9-]+)*$')])],
          ...
          key: "trimEmail",
          value: function trimEmail(event, type) {
            if (type === 'email') {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 10:
                      ...
                      _context.prev = 22;
                      _context.next = 25;
                      return this.authService.signUp(user).toPromise();
                    ...
                    case 29:
                      ...
                      _context.next = 33;
                      return this.sharedService.setNativeStorage('token', loginRes.token);
      ...
      SignUpPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
