  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    function NcNw(module, __webpack_exports__, __webpack_require__) {
      ...
      var DashboardPage = /*#__PURE__*/function () {
        function DashboardPage(sharedService, platform, lessonsService, router, navController, toastController, loadingController, actionSheetController, onBoardingService) {
          var _this = this;
          ...
          sharedService.getDeviceInfo().then(function (info) {
            ...
            _this.sharedService.gaTrackView('Dashboard Screen');
          });
        }
        ...
        _createClass(DashboardPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.sharedService.getNativeStorage('leftOfData').then(function (leftOfData) {
              if (leftOfData === null || leftOfData === void 0 ? void 0 : leftOfData.data) {
                _this2.showQuickActions(leftOfData.data);
              }
          ...
          value: function showQuickActions(details) {
                      ...
                      return this.actionSheetController.create({
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this3.navController.setDirection('forward');

                            _this3.router.navigate(['/lesson-steps', details.lessonID, false, 'resume']);
                          }
                        }, {
                          text: "Begin today's recommended lesson",
                          handler: function handler() {
                            _this3.gotoTodaysLesson();
                          }
                        }, {
                          text: 'Explore other lessons',
                          handler: function handler() {
                            _this3.router.navigate(['/dashboard/search-lessons']);
                          }
                        }, {
                          text: 'Cancel',
                          role: 'cancel'
          ...
          key: "gotoTodaysLesson",
          value: function gotoTodaysLesson() {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 6:
                      _context2.next = 8;
                      return this.lessonsService.getTodaysLesson().toPromise();
          ...
          value: function loadScripts() {
            var dynamicScripts = '../../../../assets/js/channel.js';
      ...
      DashboardPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["Platform"], _services_lessons_service__WEBPACK_IMPORTED_MODULE_4__["LessonsService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ActionSheetController"], _services_on_boarding_service__WEBPACK_IMPORTED_MODULE_5__["OnBoardingService"]])], DashboardPage);
      /***/
    },
    ...
    function Oy4E(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | search-lessons-search-lessons-module */
            [__webpack_require__.e("default~dashboard-lessons-new-uploads-new-uploads-module~dashboard-search-lessons-search-list-search~bc67e8ae"), __webpack_require__.e("common"), __webpack_require__.e("search-lessons-search-lessons-module")]).then(__webpack_require__.bind(null,
            /*! ./search-lessons/search-lessons.module */
            "jSAL")).then(function (m) {
              return m.SearchLessonsPageModule;
            });
          }
        }, {
          path: 'review',
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e("default~dashboard-lessons-lesson-details-lesson-details-module~dashboard-lessons-lesson-details-less~7a81a0d9"), __webpack_require__.e("default~dashboard-lessons-lesson-details-lesson-details-module~dashboard-lessons-lesson-details-less~d7cf5b72"), __webpack_require__.e(3), __webpack_require__.e("default~dashboard-lessons-lesson-details-lesson-details-module~dashboard-lessons-lesson-details-less~d7afd9d0"), __webpack_require__.e("default~dashboard-lessons-lesson-details-lesson-details-module~dashboard-lessons-lesson-details-less~e303b970"), __webpack_require__.e("common"), __webpack_require__.e("review-review-module")]).then(__webpack_require__.bind(null,
            /*! ./review/review.module */
            "bZRo")).then(function (m) {
