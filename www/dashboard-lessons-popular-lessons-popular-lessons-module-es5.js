(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-lessons-popular-lessons-popular-lessons-module"], {
    ...
    /***/
    function G6q8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Hh7y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopularLessonsPageModule", function () {
        return PopularLessonsPageModule;
      });
      /* harmony import */
      ...
      var _popular_lessons_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./popular-lessons.page */
      "MAJ5");
      ...
      var PopularLessonsPageModule = function PopularLessonsPageModule() {
        _classCallCheck(this, PopularLessonsPageModule);
      };

      PopularLessonsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function MAJ5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PopularLessonsPage", function () {
        return PopularLessonsPage;
      });
      /* harmony import */
      ...
      var _raw_loader_popular_lessons_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./popular-lessons.page.html */
      "fFBO");
      /* harmony import */


      var _popular_lessons_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./popular-lessons.page.scss */
      "G6q8");
      /* harmony import */
      ...
      var PopularLessonsPage = /*#__PURE__*/function () {
        function PopularLessonsPage(router, sharedService, navController, lessonsService) {
          _classCallCheck(this, PopularLessonsPage);
        ...
        _createClass(PopularLessonsPage, [{
          ...
          value: function getPopularLessons(event) {
            var _this = this;

            try {
              this.lessonsService.getPopularLessons(this.nextPage).subscribe(function (res) {
                if (_this.nextPage === 1) {
                  _this.popularLessons = [];
                }
          ...
          value: function loadData(event) {
            ...
            setTimeout(function () {
              ...
              _this2.isPopularLessons = true;

              _this2.getPopularLessons(event);
            }, 500);
          }
        }]);
      ...
      PopularLessonsPage.ctorParameters = function () {
        return [{
      ...
      PopularLessonsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services_shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _services_lessons_service__WEBPACK_IMPORTED_MODULE_3__["LessonsService"]])], PopularLessonsPage);
      /***/
    },
    ...
    /***/
    function fFBO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=dashboard-lessons-popular-lessons-popular-lessons-module-es5.js.map