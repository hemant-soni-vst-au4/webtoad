...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OnBoardingLevelPageModule", function() { return OnBoardingLevelPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var ngx_y2_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngx-y2-player */ "k9H9");
...
/* harmony import */ var _on_boarding_level_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./on-boarding-level.page */ "sgi/");
...
let OnBoardingLevelPageModule = class OnBoardingLevelPageModule {
};
OnBoardingLevelPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            ngx_y2_player__WEBPACK_IMPORTED_MODULE_1__["NgxY2PlayerModule"],
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OnBoardingLevelPage", function() { return OnBoardingLevelPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_on_boarding_level_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./on-boarding-level.page.html */ "FuWY");
/* harmony import */ var _on_boarding_level_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./on-boarding-level.page.scss */ "iC4g");
...
/* harmony import */ var ngx_y2_player__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-y2-player */ "k9H9");
...
let OnBoardingLevelPage = class OnBoardingLevelPage {
    constructor(onBoardingService, router, alertController, navController, platform, sharedService) {
    ...
    userGuid() {
        try {
            this.onBoardingService.userGuid({ language: 'eng' }).subscribe((res) => {
    ...
    levelList() {
        try {
            this.onBoardingService.levelList().subscribe((res) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                // console.log( res );
    ...
    selectLevel(event) {
        if (event) {
            ...
            const findLevel = this.levels.find((level) => level.id === this.currentLevel['userLevelId']);
    ...
    nextQuestion() {
        ...
        try {
            this.onBoardingService.changeLevel(this.currentLevel).subscribe((res) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
OnBoardingLevelPage.ctorParameters = () => [
...
OnBoardingLevelPage.propDecorators = {
    video: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__["ViewChild"], args: ['video', { static: false },] }]
};
OnBoardingLevelPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=on-boarding-on-boarding-level-on-boarding-level-module-es2015.js.map